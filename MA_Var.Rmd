...
```{r}
par(mfcol=c(3,3))
hist(df$P_Obesity, xlab = "Proportion of Obesity per County", main = "", col = "red")
hist(df$MedianIncE)
hist(df$P_HS)
hist(df$P_FastFood)
hist(df$P_Doctor)
